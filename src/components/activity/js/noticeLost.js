...
root.data = function () {
  return {
    ...
    langs: {
      ...
      two: this.$store.state.lang == 'CH' ? '活动内容：活动期间凡参与IOST交易的用户，按IOST交易量（买入量+卖出量）进行排名发放IOST奖励' : 'Details: EUNEX offers extra bonus for valuable IOST market members. Top 50 members with high volume IOST transactions (sum of both Buy and Sell amount) will get the bonus.Bonus for Valuable IOST Market Members :',
      ...
      five_two: this.$store.state.lang == 'CH' ? '如发现恶意交易等不当行为，EUNEX有权取消活动资格及奖励' : 'Any behavior of unfair competition will be disqualified immediately.',
      five_three: this.$store.state.lang == 'CH' ? '本活动最终解释权归EUNEX所有' : 'EUNEX reserves the right of further adjustment and final interpretation of this announcement.',
      ...
      recharge_four_two: this.$store.state.lang == 'CH' ? '如发现恶意充值等不当行为，EUNEX有权取消活动资格及奖励' : 'Any behavior of unfair competition will be disqualified immediately.',
      recharge_four_three: this.$store.state.lang == 'CH' ? '本活动最终解释权归EUNEX所有' : 'EUNEX reserves the right of further adjustment and final interpretation of this announcement',
      ...
      activity_rule_detail_3_detail_2: this.$store.state.lang == 'CH' ? '推荐新用户注册并实名认证，推荐者获得50枚IOST奖励，同时新用户也将获得50枚IOST奖励，总计20万枚IOST送完即止！先推荐先注册先得！' : 'EUNEX user, who refers a friend to register and finish the KYC verification, will get 50 IOST reward. 50 IOST will be rewarded to the new member as well. Due to limited quantity of the coin, whoever comes first gets first, till all IOST bonuses are given out. ',
      ...
      activity_rule_detail_3_detail_4_2: this.$store.state.lang == 'CH' ? '2.如发现恶意推荐、注册等不当行为，EUNEX有权取消活动资格及奖励；' : '2.      Any behavior of unfair competition will be disqualified immediately.',
      activity_rule_detail_3_detail_4_3: this.$store.state.lang == 'CH' ? '3.本活动最终解释权归EUNEX所有。' : '3.      EUNEX reserves the right of further adjustment and final interpretation of this announcement.',
      ...
      activity_rule_detail_2_detail_2: this.$store.state.lang == 'CH' ? '活动期间凡参与IOST交易的用户，按IOST交易量（买入量+卖出量）进行排名发放IOST奖励；' : 'EUNEX offers extra bonus for valuable IOST market members. Top 50 members with high volume IOST transactions (sum of both Buy and Sell amount) will get the bonus.',
      ...
      activity_rule_detail_2_detail_5_2: this.$store.state.lang == 'CH' ? '2.如发现恶意交易等不当行为，EUNEX有权取消活动资格及奖励；' : '2. Any behavior of unfair competition will be disqualified immediately.',
      activity_rule_detail_2_detail_5_3: this.$store.state.lang == 'CH' ? '3.本活动最终解释权归EUNEX所有。' : '3. EUNEX reserves the right of further adjustment and final interpretation of this announcement.',
      ...
      activity_rule_detail_1_detail_4_2: this.$store.state.lang == 'CH' ? '2.如发现恶意充值等不当行为，EUNEX有权取消活动资格及奖励；' : '2.Any behavior of unfair competition will be disqualified immediately. ',
      activity_rule_detail_1_detail_4_3: this.$store.state.lang == 'CH' ? '3.本活动最终解释权归EUNEX所有。' : '3.EUNEX reserves the right of further adjustment and final interpretation of this announcement.',
      // 注册时间
