...
function SlideBar(data){
  console.log("data====="+data.actionBlock);
  let _this = this;
  let oActionBlock = document.getElementById(data.actionBlock);
  let oActionBar = document.getElementById(data.actionBar);
	let oSlideBar = document.getElementById(data.slideBar);

	console.log("oSlideBar===="+oSlideBar.innerText);

  let actionbar2 = document.getElementById(data.actionbar2);
  let actionbar3 = document.getElementById(data.actionbar3);
  let actionbar4 = document.getElementById(data.actionbar4);



  let barLength = data.barLength;
