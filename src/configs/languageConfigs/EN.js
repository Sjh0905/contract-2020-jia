...
root.helpApplyToList.descript_10 = 'We only accept email submission, please submit the following information to the email address: blockchain@btcdo.com'
root.helpApplyToList.descript_11 = 'If you want your coin to be listed on eunex.group, please apply by providing your coin information details in the following link:'
...
root.helpUserAgreement.descript_1 = "This service agreement is made by you (hereinafter referred to as \"you\") and EUNEX digital asset exchange platform (hereinafter referred to as \"EUNEX\"). You access, use, or click on the \"I agree\" nine cattle or any of the below website (https://www.eunex.group), API (https://api.eunex.group) and mobile applications to provide any services or below any affiliated agency website to provide other related services (hereinafter referred to as \"the services\"), namely, said are you sure you have read, understand and accept the terms of use agreement (hereinafter referred to as \"the terms of use\") of all the terms and conditions, in addition, when using this service is part of the function, You may also need to comply with additional terms and conditions that apply to these features."
...
root.personalCenterToAuthenticate.hold_china = 'Selfie with Photo ID and Note'
...
root.personalCenterSecurityStrategy.login = 'Log in'
...
root.whiteList.qq_4 = '4. Set domain whitelist by entering btcdo.com'
