...
requestAddress.GET_CAPITAL_SEARCH = {url: urlHead + '/future/orders/historyOrders', method: 'get',} // 历史委托搜索
...
requestAddress.GET_CAPITAL_CANCELALL = {url: urlHead + '/future/orders/cancelAllOrders', method: 'post',} // 取消全部订单
