...
var IE = false;
var iolang = 'en';
// var servername = 'iohk.io';
var requesturi = '/';
// var homeurl = 'https://iohk.io';
var sitename = 'Input Output';
var homename = 'Cascading Disruption';
// var temppath = '/js/globe/';
var pageslug = 'home';
var teampage = 'team';
var jobspage = 'careers';
var projectspage = 'projects';

var iolab_read_more = 'Read more';
var iolab_link = 'Link';
var iolab_open = 'Open';
var iolab_close = 'Close';
var iolab_back = 'Back';

var iolab_share_on_Twitter = 'Share on Twitter';
var iolab_share_on_Facebook = 'Share on Facebook';
var iolab_share_on_LinkedIn = 'Share on LinkedIn';
var iolab_share_on_Google_Plus = 'Share on Google Plus';
var iolab_share_on_Reddit = 'Share on Reddit';
...
function io_disqus(){
	...
	(function() {
	    ...
	    s.src = 'https://iohk.disqus.com/embed.js';
...
function io_which_way_alter(){
	...
	if($("#io_intro").hasClass('ready')){
		...
		$.getScript( "/static/bg_canvas/GPUFluid.js", function( data, textStatus, jqxhr ) {
				$.getScript( "/static/bg_canvas/start.js", function( data, textStatus, jqxhr ) {
					$.getScript( "/static/bg_canvas/hammer.js", function( data, textStatus, jqxhr ) {
						$.getScript( "/static/bg_canvas/app.js", function( data, textStatus, jqxhr ) {
								homeloaded = true;
